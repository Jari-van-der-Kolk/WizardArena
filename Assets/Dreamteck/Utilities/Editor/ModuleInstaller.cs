namespace Dreamteck.Editor
{
    ...
    public class ModuleInstaller
    {
        ...
        public void Install()
        {
            ...
            string globalPath = Path.Combine(Application.dataPath, DREAMTECK_FOLDER_NAME + "/" + _packageDirectory);
        ...
        public void Uninstall()
        {
            ...
            for (int i = 0; i < _uninstallDirectories.Count; i++)
            {
                ...
                string globalPath = Path.Combine(Application.dataPath, DREAMTECK_FOLDER_NAME + "/" + _uninstallDirectories[i]);
