...
public class StatusEffectTemplate : EffectBase
{
    public StatusEffectTemplate(LayerMask targetMask, int statusHealthModifierAmount) : base(targetMask, statusHealthModifierAmount)
    {
    }
