...
{
    public class SpellCasterPrototype : MonoBehaviour
    {
        ...
        public SpellComboPrototype _currentCombo;
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                SpellSOPrototype spell = SpellManagerPrototype.Instance.GetSpellFromCombo(_currentCombo);
                if (spell == null)
                {
        ...
        {
            _selectedShapes = SpellManagerPrototype.Instance.GetSelectedShapes();
            _selectedElements = SpellManagerPrototype.Instance.GetsSelectedElements();
            _selectedActivation = SpellManagerPrototype.Instance.GetSelectedActivations();
        }
        ...
        private void CastSpell(SpellSOPrototype spell)
        {
            ...
            List<SpellPrototype> components = new List<SpellPrototype>();
            foreach (var component in spell.GetAllDependencies())
            {
                SpellPrototype spellComponent = (SpellPrototype)spellObject.AddComponent(component);
