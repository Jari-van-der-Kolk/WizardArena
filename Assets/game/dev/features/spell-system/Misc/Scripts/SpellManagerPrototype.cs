...
namespace Job.SpellSystem
{
    ...
    public class SpellManagerPrototype : MonoBehaviour
    {
        public static SpellManagerPrototype Instance;
        [SerializeField] private SpellSOPrototype[] _spells;
        ...
        private List<SpellSOPrototype> _possibleSpells = new List<SpellSOPrototype>();
        ...
        {
            foreach (SpellSOPrototype spell in _spells)
            {
        ...
        public SpellSOPrototype GetSpellFromCombo(SpellComboPrototype combo)
        {
            foreach (SpellSOPrototype spell in _possibleSpells)
            {
